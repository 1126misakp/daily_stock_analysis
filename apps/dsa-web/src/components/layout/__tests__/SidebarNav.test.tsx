...
describe('SidebarNav', () => {
  it('always shows the screening navigation item directly after chat', () => {
    render(
    ...
    const screeningLink = screen.getByRole('link', { name: '选股' });
    expect(screeningLink).toHaveAttribute('href', '/screening');
